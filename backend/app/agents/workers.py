...
def researcher_node(state: dict) -> dict:
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "You are a research agent. Summarise the following search results "
...
def coder_node(state: dict) -> dict:
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "You are a coding agent. Based on the task and any research provided, "
...
def summariser_node(state: dict) -> dict:
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "You are a synthesis agent. Combine the worker outputs into a "
